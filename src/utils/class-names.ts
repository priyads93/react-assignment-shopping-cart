export const classNames = {
  phoneNumberInput:
    "p-1 text-sm/normal fill-white rounded-md border-2 border-black-100",
  label: "font-sans text-sm mb-1",
  errorMessage: "font-sans text-sm italic mt-1 text-left text-red-500",
  input:
  ...
  form: "bg-blue-100 p-4 m-2 rounded-md relative w-auto md:w-md text-black",
